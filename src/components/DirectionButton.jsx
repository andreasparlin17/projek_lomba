...
const DirectionButton = ({type}) => {
    ...
    if(type=='button'){
        ...
        return (
            <button className='hover:cursor-pointer bg-[#3B3B3B] p-3 font-thin text-sm flex items-center justify-center gap-1.5 w-full text-nowrap'>See Directions <RiExternalLinkLine size={18} className='inline'/></button>
        )
    }
