...
const NearestCard = () => {
  return (
    <div className='z-50- relative lg:w-[65%] md:w-[80%] w-[90%] lg:pb-0 md:aspect-[1920/1200] bg-[#272727] shadow-card-shadow mb-4 lg:rounded-[50px] md:rounded-3xl rounded-xl overflow-hidden -z-[1] h-96'>
      ...
      {/* Responsive Image */}
      <img 
        src='/assets/bus-card-image.webp'
